...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="card card-primary">
      <div class="card-header"><h3 class="card-title">Form Edit Link</h3></div>
      ...
      <form action="{{ route('social_media.update', $socialMedia->id) }}" method="POST">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" name="link" id="link" class="form-control" value="{{ old('link', $socialMedia->link) }}" required>
          </div>
        </div>
